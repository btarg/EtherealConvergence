...
public class ModComponents {
    ...
    public static final Codec<RequestData> REQUEST_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            BlockPos.CODEC.fieldOf("blockPos").forGetter(RequestData::blockPos)
    ).apply(instance, (requester, time, typeIndex, blockPos) ->
            new RequestData(requester, time, ERequestType.fromIndex(typeIndex), blockPos)));
    ...
    public static final StreamCodec<ByteBuf, RequestData> REQUEST_STREAM_CODEC = StreamCodec.composite(
            ...
            BlockPos.STREAM_CODEC, RequestData::blockPos,
            RequestData::new
    );
